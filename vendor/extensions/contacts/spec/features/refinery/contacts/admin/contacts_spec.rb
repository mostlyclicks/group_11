    ...
    module Admin
      describe Contact, type: :feature do
       ...
       describe "contacts list" do
          before do
            FactoryGirl.create(:contact, :full_name => "UniqueTitleOne")
            FactoryGirl.create(:contact, :full_name => "UniqueTitleTwo")
          end
      ...
      describe "action links" do
        ...
        describe "destroy" do
          before { FactoryGirl.create(:contact, :full_name => "UniqueTitleOne") }
